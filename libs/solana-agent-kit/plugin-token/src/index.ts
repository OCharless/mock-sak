...
// Import all tools
import { getTokenAddressFromTicker, getTokenDataByAddress } from "./dexscreener/tools";
import {
...
import { burnTokens, closeAccounts, mergeTokens, spreadToken } from "./solutiofi/tools/solutiofi";
