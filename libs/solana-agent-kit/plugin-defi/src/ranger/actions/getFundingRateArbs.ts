...
export const getFundingRateArbsAction: Action = {
    ...
    similes: ["get funding rate arbs", "fetch funding arbitrage", "funding rate opportunities"],
    ...
    handler: async (
        ...
        if (input.min_diff !== undefined) params.set("min_diff", input.min_diff.toString());
