...
export type GetLiquidationsTotalsInput = z.infer<typeof getLiquidationsTotalsSchema>;
...
export const getLiquidationsTotalsAction: Action = {
    ...
    similes: ["get liquidations totals", "fetch liquidation totals", "liquidations summary"],
    ...
    handler: async (
        ...
        const response = await fetch(`${RANGER_DATA_API_BASE}/v1/liquidations/totals`, {
            method: "GET",
            headers: {
