...
export type GetLiquidationsLatestInput = z.infer<typeof getLiquidationsLatestSchema>;
...
export const getLiquidationsLatestAction: Action = {
    ...
    similes: ["get latest liquidations", "fetch liquidations", "liquidations latest"],
    ...
    handler: async (
        ...
        const response = await fetch(`${RANGER_DATA_API_BASE}/v1/liquidations/latest`, {
            method: "GET",
            headers: {
