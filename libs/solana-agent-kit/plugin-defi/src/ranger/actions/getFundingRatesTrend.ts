...
export type GetFundingRatesTrendInput = z.infer<typeof getFundingRatesTrendSchema>;
...
export const getFundingRatesTrendAction: Action = {
    ...
    similes: ["get funding rates trend", "fetch funding trend", "funding rates history"],
