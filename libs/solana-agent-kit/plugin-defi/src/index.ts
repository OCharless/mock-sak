import type { Plugin, SolanaAgentKit } from "../../core/src";
...
import { cancelAllOrders, limitOrder, manifestCreateMarket, withdrawAll } from "./manifest/tools";
...
import { raydiumCreateAmmV4, raydiumCreateClmm, raydiumCreateCpmm } from "./raydium";

// Import Solayer tools
import { stakeWithSolayer } from "./solayer/tools";

// Import Voltr tools
import { voltrDepositStrategy, voltrGetPositionValues, voltrWithdrawStrategy } from "./voltr/tools";
