...
export default class AdrenaClient {
    public static programId = new PublicKey("13gDzEXCdocbj8iAiqrScGo47NiSuYENGsRqi3SEAwet");
    ...
    public static mainPool = new PublicKey("4bQRutgDJs6vuh6ZcWaPVXiQaBzbHketjbCDjL4oRN34");
    ...
    public static findCustodyAddress(mint: PublicKey): PublicKey {
        return PublicKey.findProgramAddressSync(
            [Buffer.from("custody"), AdrenaClient.mainPool.toBuffer(), mint.toBuffer()],
            AdrenaClient.programId
        )[0];
    }
    ...
    public static lmStaking = AdrenaClient.getStakingPda(AdrenaClient.lmTokenMint);

    public static lpStaking = AdrenaClient.getStakingPda(AdrenaClient.lpTokenMint);
    ...
    public static findATAAddressSync(wallet: PublicKey, mint: PublicKey): PublicKey {
        return PublicKey.findProgramAddressSync(
    ...
    public static lmStakingRewardTokenVault = AdrenaClient.getStakingRewardTokenVaultPda(
        AdrenaClient.lmStaking
    );
    public static lpStakingRewardTokenVault = AdrenaClient.getStakingRewardTokenVaultPda(
        AdrenaClient.lpStaking
    );
