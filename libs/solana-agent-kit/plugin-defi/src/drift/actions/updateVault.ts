...
const updateDriftVaultAction: Action = {
    ...
    schema: z.object({
        ...
        marketName: z
            ...
            .optional(),
        redeemPeriod: z.number().int().min(1, "Redeem period must be at least 1 day").optional(),
        maxTokens: z
            .number()
            .int()
        ...
        permissioned: z.boolean().optional().describe("Should the vault have a whitelist of not"),
    }),
