...
const getPriceInferenceAction: Action = {
    ...
    schema: z.object({
        tokenSymbol: z.string().min(1).describe("The token symbol to get the price inference for"),
        timeframe: z.string().min(1).describe("The timeframe to get the price inference for"),
    }),
