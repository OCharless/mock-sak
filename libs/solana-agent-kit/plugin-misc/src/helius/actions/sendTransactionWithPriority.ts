...
const sendTransactionWithPriorityFeeAction: Action = {
    ...
    similes: ["send SOL with fee", "transfer tokens with priority", "execute priority transaction"],
    description:
    ...
    schema: z.object({
        ...
        amount: z.number().positive().describe("Amount of SOL or SPL tokens to send."),
    ...
    handler: async (agent: SolanaAgentKit, input: Record<string, any>) => {
        ...
        const splmintPublicKey = splmintAddress ? new PublicKey(splmintAddress) : undefined;
