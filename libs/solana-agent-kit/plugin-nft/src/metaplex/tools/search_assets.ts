import { SearchAssetsRpcInput, dasApi } from "@metaplex-foundation/digital-asset-standard-api";
 ...
 */
export async function search_assets(agent: SolanaAgentKit, params: SearchAssetsRpcInput) {
