...
export async function deploy_token(
    ...
    try {
        ...
        if (authority?.freezeAuthority === null) {
            ...
            defaultAuthority.freezeAuthority = new PublicKey(authority?.freezeAuthority);
        }

        if (authority?.updateAuthority !== undefined && authority?.updateAuthority !== null) {
            defaultAuthority.updateAuthority = new PublicKey(authority?.updateAuthority);
        }
