...
export async function listNFTForSale(agent: SolanaAgentKit, nftMint: PublicKey, price: number) {
    try {
        ...
        const nftSource = await getAssociatedTokenAddress(nftMint, agent.wallet.publicKey);
